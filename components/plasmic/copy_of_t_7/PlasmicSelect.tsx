...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: yDTPWQ0hQQYK/component
import Select__Option from "../../Select__Option"; // plasmic-import: bWwYmGoxXW2h/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: XX34VlCji-04/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: qAHxie4pG5fD4zBBMRe14U/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: XdSsvWChsiRe/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: KgBxeV434XAj/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: -iJAGOVVVZ4L/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__lxu0T)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option__nXq0T)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
