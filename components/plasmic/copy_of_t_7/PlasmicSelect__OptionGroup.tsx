...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: XX34VlCji-04/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: XdSsvWChsiRe/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__tlyJp)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__kqeT5)}
              />
            </React.Fragment>
          ),
          value: args.children
